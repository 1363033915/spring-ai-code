package com.ai.zhu.controller.advisor.basic;
...
public class MemoryMessageAdvisorController {
    ...
    @GetMapping("/call")
    public String call(@RequestParam(value = "query", defaultValue = "你好，我的外号是朱陈龙，请记住呀") String query,
                       @RequestParam(value = "conversation_id", defaultValue = "ZhuChenLong") String conversationId
                       ) {
    ...
    @GetMapping("/messages")
    public List<Message> messages(@RequestParam(value = "conversation_id", defaultValue = "ZhuChenLong") String conversationId) {
